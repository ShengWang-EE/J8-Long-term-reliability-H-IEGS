function [results, information, solution] = GEopf_yalmip(mpc,GEoptions)
...
penalty = 100;% penalty factor for SOC relaxations
...
penaltyTerm = penalty * sum(Gf);
objfcn = objfcn_IEGSoperatingCost(Pg,LCe,PGs,Qptg,LCg,mpc,CDFe,CDFg,id,iGd) + 1*penaltyTerm;
...
[results.operatingCost, results.electricityGenerationCost, results.electricityLoadCurtailmentCost, ...
